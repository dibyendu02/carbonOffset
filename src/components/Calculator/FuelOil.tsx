...
function FuelOil({ addInput }: FuelOilProps) {
    const [monthlyConsumption, setMonthlyConsumption] = useState<number>(() => {
        const savedConsumption = localStorage.getItem('fuelOilMonthlyConsumption');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('fuelOilMonthlyConsumption', monthlyConsumption.toString());
